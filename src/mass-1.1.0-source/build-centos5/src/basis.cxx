...
static inline bool executing_in_build_tree()
{
    ...
    string rel_path = os::path::relpath(
            ...
            os::path::realpath("/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5"));
...
string bindir()
{
    if (executing_in_build_tree()) {
        return "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/bin";
    } else {
...
{
    if (executing_in_build_tree()) {
        return "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/lib";
    } else {
...
ExecutableTargetInfo::ExecutableTargetInfo()
{
    ...
    _build_dirs  ["mass.mass"]                            = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/bin";
    _install_dirs["mass.mass"]                            = "/sbia/sbiasfw/lab/mass/1.1.0/bin";

    // mass-chooseTemplates
    _exec_names  ["mass.mass-chooseTemplates"]            = "mass-chooseTemplates";
    _build_dirs  ["mass.mass-chooseTemplates"]            = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/bin";
    _install_dirs["mass.mass-chooseTemplates"]            = "/sbia/sbiasfw/lab/mass/1.1.0/bin";

    // mass-thresholdJacobian
    _exec_names  ["mass.mass-thresholdJacobian"]          = "mass-thresholdJacobian";
    _build_dirs  ["mass.mass-thresholdJacobian"]          = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/bin";
    _install_dirs["mass.mass-thresholdJacobian"]          = "/sbia/sbiasfw/lab/mass/1.1.0/bin";

    // mass-fillHoles
    _exec_names  ["mass.mass-fillHoles"]                  = "mass-fillHoles";
    _build_dirs  ["mass.mass-fillHoles"]                  = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/lib";
    _install_dirs["mass.mass-fillHoles"]                  = "/sbia/sbiasfw/lab/mass/1.1.0/lib";

    // mass-morpho
    _exec_names  ["mass.mass-morpho"]                     = "mass-morpho";
    _build_dirs  ["mass.mass-morpho"]                     = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/lib";
    _install_dirs["mass.mass-morpho"]                     = "/sbia/sbiasfw/lab/mass/1.1.0/lib";

    // mass-registrations
    _exec_names  ["mass.mass-registrations"]              = "mass-registrations";
    _build_dirs  ["mass.mass-registrations"]              = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/lib";
    _install_dirs["mass.mass-registrations"]              = "/sbia/sbiasfw/lab/mass/1.1.0/lib";

    // mass-skullstripping
    _exec_names  ["mass.mass-skullstripping"]             = "mass-skullstripping";
    _build_dirs  ["mass.mass-skullstripping"]             = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/lib";
    _install_dirs["mass.mass-skullstripping"]             = "/sbia/sbiasfw/lab/mass/1.1.0/lib";

    // mass-choosetemplate
    _exec_names  ["mass.mass-choosetemplate"]             = "mass-choosetemplate";
    _build_dirs  ["mass.mass-choosetemplate"]             = "/sbia/home/bergman/MASS/MASS_1.1.0/build-centos5/lib";
    _install_dirs["mass.mass-choosetemplate"]             = "/sbia/sbiasfw/lab/mass/1.1.0/lib";

    // basis.testdriver
    _exec_names  ["basis.testdriver"]                     = "testdriver";
    _build_dirs  ["basis.testdriver"]                     = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.testdriver"]                     = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.basisproject
    _exec_names  ["basis.basisproject"]                   = "basisproject";
    _build_dirs  ["basis.basisproject"]                   = "/sbiasfw/lab/basis/2.1.2/centos5/bin";
    _install_dirs["basis.basisproject"]                   = "/sbiasfw/lab/basis/2.1.2/centos5/bin";

    // basis.doxyfilter
    _exec_names  ["basis.doxyfilter"]                     = "doxyfilter";
    _build_dirs  ["basis.doxyfilter"]                     = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.doxyfilter"]                     = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.doxyfilter-perl
    _exec_names  ["basis.doxyfilter-perl"]                = "doxyfilter-perl";
    _build_dirs  ["basis.doxyfilter-perl"]                = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.doxyfilter-perl"]                = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.basistest-svn
    _exec_names  ["basis.basistest-svn"]                  = "basistest-svn";
    _build_dirs  ["basis.basistest-svn"]                  = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.basistest-svn"]                  = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.basistest-slave
    _exec_names  ["basis.basistest-slave"]                = "basistest-slave";
    _build_dirs  ["basis.basistest-slave"]                = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.basistest-slave"]                = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.basistest-master
    _exec_names  ["basis.basistest-master"]               = "basistest-master";
    _build_dirs  ["basis.basistest-master"]               = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.basistest-master"]               = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.basistest-cron
    _exec_names  ["basis.basistest-cron"]                 = "basistest-cron";
    _build_dirs  ["basis.basistest-cron"]                 = "/sbiasfw/lab/basis/2.1.2/centos5/lib";
    _install_dirs["basis.basistest-cron"]                 = "/sbiasfw/lab/basis/2.1.2/centos5/lib";

    // basis.basistest
    _exec_names  ["basis.basistest"]                      = "basistest";
    _build_dirs  ["basis.basistest"]                      = "/sbiasfw/lab/basis/2.1.2/centos5/bin";
    _install_dirs["basis.basistest"]                      = "/sbiasfw/lab/basis/2.1.2/centos5/bin";

    // dramms.CheckTwoImages
    _exec_names  ["dramms.CheckTwoImages"]                = "CheckTwoImages";
    _build_dirs  ["dramms.CheckTwoImages"]                = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.CheckTwoImages"]                = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.GenerateGaborListFile
    _exec_names  ["dramms.GenerateGaborListFile"]         = "GenerateGaborListFile";
    _build_dirs  ["dramms.GenerateGaborListFile"]         = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.GenerateGaborListFile"]         = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.GenerateImageListFile
    _exec_names  ["dramms.GenerateImageListFile"]         = "GenerateImageListFile";
    _build_dirs  ["dramms.GenerateImageListFile"]         = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.GenerateImageListFile"]         = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.CalculateImageSimilarity
    _exec_names  ["dramms.CalculateImageSimilarity"]      = "CalculateImageSimilarity";
    _build_dirs  ["dramms.CalculateImageSimilarity"]      = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.CalculateImageSimilarity"]      = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.CombineFeatureLists
    _exec_names  ["dramms.CombineFeatureLists"]           = "CombineFeatureLists";
    _build_dirs  ["dramms.CombineFeatureLists"]           = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.CombineFeatureLists"]           = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.CombineTransforms
    _exec_names  ["dramms.CombineTransforms"]             = "dramms-combine";
    _build_dirs  ["dramms.CombineTransforms"]             = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.CombineTransforms"]             = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.CalculateGaborTextures
    _exec_names  ["dramms.CalculateGaborTextures"]        = "CalculateGaborTextures";
    _build_dirs  ["dramms.CalculateGaborTextures"]        = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.CalculateGaborTextures"]        = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.MatchHistograms
    _exec_names  ["dramms.MatchHistograms"]               = "MatchHistograms";
    _build_dirs  ["dramms.MatchHistograms"]               = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.MatchHistograms"]               = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.ApplyTransform
    _exec_names  ["dramms.ApplyTransform"]                = "dramms-warp";
    _build_dirs  ["dramms.ApplyTransform"]                = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.ApplyTransform"]                = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.CalculateJacobianMap
    _exec_names  ["dramms.CalculateJacobianMap"]          = "dramms-jacobian";
    _build_dirs  ["dramms.CalculateJacobianMap"]          = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.CalculateJacobianMap"]          = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.CalculateRavensMaps
    _exec_names  ["dramms.CalculateRavensMaps"]           = "dramms-ravens";
    _build_dirs  ["dramms.CalculateRavensMaps"]           = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.CalculateRavensMaps"]           = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.ImageOperation
    _exec_names  ["dramms.ImageOperation"]                = "dramms-imgop";
    _build_dirs  ["dramms.ImageOperation"]                = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.ImageOperation"]                = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.TransformOperation
    _exec_names  ["dramms.TransformOperation"]            = "dramms-defop";
    _build_dirs  ["dramms.TransformOperation"]            = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.TransformOperation"]            = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.ConvertDeformation
    _exec_names  ["dramms.ConvertDeformation"]            = "dramms-convert";
    _build_dirs  ["dramms.ConvertDeformation"]            = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.ConvertDeformation"]            = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";

    // dramms.ConvertImage
    _exec_names  ["dramms.ConvertImage"]                  = "ConvertImage";
    _build_dirs  ["dramms.ConvertImage"]                  = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.ConvertImage"]                  = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.Deform2D
    _exec_names  ["dramms.Deform2D"]                      = "Deform2D";
    _build_dirs  ["dramms.Deform2D"]                      = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.Deform2D"]                      = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.Deform3D
    _exec_names  ["dramms.Deform3D"]                      = "Deform3D";
    _build_dirs  ["dramms.Deform3D"]                      = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";
    _install_dirs["dramms.Deform3D"]                      = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/lib";

    // dramms.dramms
    _exec_names  ["dramms.dramms"]                        = "dramms";
    _build_dirs  ["dramms.dramms"]                        = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
    _install_dirs["dramms.dramms"]                        = "/sbia/sbiasfw/lab/dramms/centos5/1.4.1/bin";
}
