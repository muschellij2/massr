...
. /sbia/sbiasfw/lab/mass/1.1.0/lib/bash/mass/SettingsSGE.sh 2>/dev/null && { isSchedulerAvailable=1; }
...
### Default parameters
scripts=/sbia/sbiasfw/lab/mass/1.1.0/lib/
...
then
	if [ "$Cere" == "1" ]
	then
		ref=/sbia/sbiasfw/lab/mass/1.1.0/share/data/Templates/WithCerebellum/
	elif [ "$Cere" == "0" ]
	then
		ref=/sbia/sbiasfw/lab/mass/1.1.0/share/data/Templates/WithoutCerebellum/
	fi
