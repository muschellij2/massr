...
if (MANIFEST_FILE)
  ...
  if (EXISTS "${CMAKE_CURRENT_LIST_DIR}/MASSInstallManifest.txt")
    # install manifest written to installation tree
    set (MANIFEST_FILE "${CMAKE_CURRENT_LIST_DIR}/MASSInstallManifest.txt")
...
if (WIN32 AND REGISTERED)
  set (PKGUID "SBIA-MASS-1.1.0")
  execute_process (
    COMMAND reg delete "HKCU\\Software\\Kitware\\CMake\\Packages\\MASS" /v "${PKGUID}" /f
    RESULT_VARIABLE RT
    ERROR_VARIABLE ERR
  )
  if (RT EQUAL 0)
    message (STATUS "Deregister:   Removed HKCU\\Software\\Kitware\\CMake\\Packages\\MASS\\${PKGUID}")
  else ()
